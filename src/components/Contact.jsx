...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "a1b3efe5-ef93-4edc-83a1-e57de0859c5e");
    ...
    return (
        <motion.div
            ...
            <p className='text-center text-gray-500 mb-12 max-w-80 mx-auto'>Ready to Make A Move? Let's Build Your Futute Together </p>
