        ...
        <div className='min-h-screen mb-4  bg-cover bg-center flex items-center w-full overflow-hidden'
            ...
            <motion.div
                ...
                <div className='flex flex-col sm:flex-row items-center justify-center gap-4 mt-16'>
                    <a href="#Projects" className='border border-white px-8 py-3 rounded text-center w-full sm:w-auto'>Projects</a>
                    <a href="#Contact" className='bg-blue-500 px-8 py-3 rounded text-center w-full sm:w-auto'>Contact Us</a>
                </div>
